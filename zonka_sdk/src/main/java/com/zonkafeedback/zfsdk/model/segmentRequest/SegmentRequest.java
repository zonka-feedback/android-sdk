...
import com.zonkafeedback.zfsdk.model.trackingRequestModel.PagesViewedLog;
...
public class SegmentRequest {
    ...
    public final static Parcelable.Creator<SegmentRequest> CREATOR = new Parcelable.Creator<SegmentRequest>() {


        public SegmentRequest createFromParcel(android.os.Parcel in) {
            return new SegmentRequest(in);
        }

        public SegmentRequest[] newArray(int size) {
            return (new SegmentRequest[size]);
        }
    ...
    protected SegmentRequest(android.os.Parcel in) {
    ...
    public List<String> getIncludedSegment() {
        return includedSegment;
    }

    public void setIncludedSegment(List<String> includedSegment) {
    ...
    public void setExcludedSegment(List<String> excludedSegment) {
